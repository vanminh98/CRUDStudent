<?php
 ...
 <!-- Breadcrumbs-->
       ...
       <h3 > <button type="button" class="btn btn-success"><a style='color:white ' href="CreateStudent.php"><i class="fa fa-plus"></i></a></button></h3>
   <table class="table">
   <hr>
        ...
        <?php
          foreach($rsFromFile as $key => $value){
             ...
             echo " <td>";
             echo "  <button type='button' class='btn btn-primary'><a style='color:white 'href='EditStudent.php?m=$value->id'><i class='fa fa-edit'></i></a></button>";
             echo "  <button type='button' class='btn btn-danger'><a style='color:white 'href='DeleteStudent.php?m=$value->id'><i class='fa fa-trash-alt'></i></a></button>";
             echo " </td>";
             echo " </tr>";
